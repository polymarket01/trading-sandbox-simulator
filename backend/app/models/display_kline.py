...
class DisplayKline(Base):
    """Public chart aggregates (real + virtual), never account or trade facts."""

    __tablename__ = "display_klines"
    __table_args__ = (
        UniqueConstraint(
            "market_id",
            "interval",
    ...
    source: Mapped[str] = mapped_column(String(32), nullable=False, default="synthetic_flow")
